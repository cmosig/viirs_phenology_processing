...
switched off. v9, the store inference reads, is visible at both resolutions;
v8, v6 and v2 are loaded for comparison. Over the Amazon and south-east Asia,
v6 shows a 1 January band -- seasons anchored on the year boundary -- while v8
shows the opposite, a hole there, because it dropped every season the sensor
only saw half of. v9 has neither.
...
LAYERS = [
    ("modis_pheno_processed_v9_10km.tif", 3, "v9 10 km - middle (measured)", True),
    ("modis_pheno_processed_v9.tif", 3, "v9 40 km - middle (measured)", True),
    ("modis_pheno_processed_v8_10km.tif", 3, "v8 10 km - middle (censored seasons dropped)", False),
    ("modis_pheno_processed_v6_10km.tif", 3, "v6 10 km - middle (1 Jan artifact)", False),
    ("modis_pheno_processed_v2.tif", 3, "v2 40 km - middle (measured)", False),
    ("modis_pheno_processed_v9_10km.tif", 6, "v9 10 km - middle_interp", False),
    ("modis_pheno_processed_v9.tif", 6, "v9 40 km - middle_interp", False),
...
def main():
    ...
    project.setTitle("Land-surface phenology v9 - day of year")
