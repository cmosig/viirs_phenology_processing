...
switched off. v8, the store inference reads, is visible at both resolutions;
v7, v6 and v2 are loaded for comparison. Over the Amazon and south-east Asia,
v6 10 km shows a 1 January band and v7 a 31 December one; both are artifacts of
seasons anchored on the year boundary, and v8 has neither.
...
LAYERS = [
    ("modis_pheno_processed_v8_10km.tif", 3, "v8 10 km - middle (measured)", True),
    ("modis_pheno_processed_v8.tif", 3, "v8 40 km - middle (measured)", True),
    ("modis_pheno_processed_v7_10km.tif", 3, "v7 10 km - middle (measured)", False),
    ...
    ("modis_pheno_processed_v8_10km.tif", 6, "v8 10 km - middle_interp", False),
    ("modis_pheno_processed_v8.tif", 6, "v8 40 km - middle_interp", False),
...
def main():
    ...
    project.setTitle("Land-surface phenology v8 - day of year")
